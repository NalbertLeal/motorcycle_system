...
class CharactersSegmentationGPU():
    def __init__(self) -> None:
        self.seg_net =  cv2.dnn_DetectionModel(
            SEGMENTATION_CFG,
        ...
        self.seg_net.setInputSize(64, 224)
        print('__init__ 1.1')
        self.seg_net.setInputScale(1.0 / 255)
        print('__init__ 1.2')
        self.seg_net.setInputSwapRB(True)
        print('__init__ 1.3')
        self.seg_net.setInputCrop(False)
        print('__init__ 3')
        # self.seg_net.setPreferableTarget(cv2.dnn.DNN_TARGET_CUDA)
    ...
    def run(self, img: np.ndarray):
        try:
            ...
            classes, confidences, boxes = self.seg_net.detect(
                img,
